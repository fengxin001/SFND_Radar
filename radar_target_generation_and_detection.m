...
% remains contant
range_initial = 70; % unit: m
vel_initial = 70;    % unit: m/s
...
c = 3e8;        % unit: m/s
R_Max = 200;    % unit: m
v_max = 100;    % unit: m/s Neglact 70 m/s listed in the project overview . 
...
CFAR_sig(CFAR_sig~=0 & CFAR_sig~=1) = 0;
...
xlabel('doppler axis(m/s)','FontWeight','bold','fontsize',16, 'Interpreter','None');
ylabel('range_axis(m)','FontWeight','bold','fontsize',16, 'Interpreter','None');
zlabel('CFAR output','FontWeight','bold','fontsize',16, 'Interpreter','None');

figure('Name','Filted Amplitude');
surf(doppler_axis,range_axis,CFAR_sig.*RDM);
set(gcf,'color','white');
colorbar;
xlabel('doppler axis(m/s)','FontWeight','bold','fontsize',16, 'Interpreter','None');
ylabel('range_axis(m)','FontWeight','bold','fontsize',16, 'Interpreter','None');
